<table class="min-w-full">
    <thead class="bg-gray-100">
        <tr>
            ...
            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Ano de Publicação</th>
    ...
    <tbody>
        ...
        <tr class="odd:bg-gray-50 even:bg-white">
            ...
            <td class="px-6 py-4">{{ $book->publication_year_formatted }}</td>
            <td class="px-1 py-4">
            ...
            <td class="px-1 py-4">
                <form action="{{ route('books.destroy', $book->id) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
                    <button type="submit" onclick="return confirm('Tem certeza que deseja excluir este livro?')">
